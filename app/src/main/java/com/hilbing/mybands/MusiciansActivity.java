...
public class MusiciansActivity extends AppCompatActivity {
                ...
                usersDataReference.child(musicianKey).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            holder.instrumentsIV.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
    ...
    public class MusicianViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView dateTV;
        @BindView(R.id.all_musicians_band_send_message_IV)
        ImageView sendMessageIV;
        @BindView(R.id.all_musicians_band_instruments_IV)
        ImageView instrumentsIV;
