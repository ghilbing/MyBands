...
public class SearchYoutubeUpdateActivity extends AppCompatActivity {

    @BindView(R.id.update_videos_RV)
    RecyclerView recyclerView;
    @BindView(R.id.update_youtube_toolbar)
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_youtube_update);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(SearchYoutubeUpdateActivity.this, VideoUpdateDetailActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                // hide keybord
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(findViewById(R.id.update_videos_RV).getWindowToken(), 0);
    ...
    private void initializeRecyclerView() {
        recyclerView = (RecyclerView) findViewById(R.id.update_videos_RV);
